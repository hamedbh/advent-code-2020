...
Counting all of the combinations is a non-starter. We can look at the table of diffs from Part 1 though: 

```{r day10-diff-table}
table(diff(day10_input))
```

Just 1 and 3. And what is the longest run of 1's in the data?
